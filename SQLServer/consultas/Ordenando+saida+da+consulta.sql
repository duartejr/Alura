...
SELECT [CODIGO DO PRODUTO] FROM [TABELA DE PRODUTOS] WHERE [NOME DO PRODUTO] = 'Linha Refrescante - 1 Litro - Morango/Limão'
SELECT TOP 1 NUMERO, QUANTIDADE FROM [ITENS NOTAS FISCAIS] WHERE [CODIGO DO PRODUTO] = '1101035' ORDER BY QUANTIDADE DESC
